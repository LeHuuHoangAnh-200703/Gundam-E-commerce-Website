                        ...
                        <table class="w-full bg-white whitespace-nowrap text-center text-gray-500">
                            ...
                            <tbody class="w-full">
                                <tr class="border-t border-slate-500">
                                    ...
                                    <td
                                        class="px-6 py-4 whitespace-nowrap text-[12px] text-ellipsis overflow-hidden max-w-40">
                                        <p class="overflow-hidden text-ellipsis text-[12px] whitespace-nowrap">RG 1/144
                                            RX-0
                                            UNICORN
                                            GUNDAM (BILIBILI 10TH ANNIVERSARY VER) - Mô hình Gundam chính hãng Bandai sở
                                            hữu
                                            đôi cánh sắc sảo tạo thành từ DRAGOON System độc đáo. Đây là một trong những
                                            mẫu
                                            Gundam cực kỳ nổi tiếng với lượng fan đông đảo, và bạn sẽ không khỏi ấn
                                            tượng về
