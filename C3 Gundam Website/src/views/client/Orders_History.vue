            ...
            <div class="w-full m-4">
                <div
                    ...
                    <div
                        ...
                        <p class="text-[14px] lg:text-[16px]">Ngày đặt hàng: <span
                                class="text-[#FFD700]">20/07/2024</span></p>
                        <p class="text-[14px] lg:text-[16px] text-[#FFD700] text-center lg:text-start"><i
