...
<template>
    <div class="bg-[#1A1D27] relative overflow-hidden min-h-screen font-sans scroll-smooth">
        ...
        <div class="relative my-5 m-5 lg:mx-[200px] flex justify-center items-center">
                    ...
                    <div class="flex flex-col gap-2 justify-center">
                        <form action="" class="flex flex-col justify-end items-end gap-6">
                            <div class="flex gap-8 w-full">
                                <div class="flex flex-col gap-4 w-1/2 text-white border-r-2 pr-10">
                                    ...
                                    <div class="flex flex-col gap-4 overflow-hidden">
                                        <div class="overflow-y-auto max-h-[200px] flex flex-col gap-4">
                                            <div class="flex gap-4">
                                                <img src="../../assets/img/RG01.jpg" class="w-[80px] border-2" alt="">
                                                <div class="">
                                                    <p class="text-white text-[14px]">RG 1/144 RX-0 UNICORN GUNDAM
                                                        (BILIBILI
                                        ...
                                        <p class="text-white text-[16px]">Phương thức thanh toán: <span
